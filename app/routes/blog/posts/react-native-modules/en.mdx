...
# Linking Dependencies inside of React Native View Modules for iOS
...
The part of the code that I will cover here is only going to be the JavaScript™️ and iOS. I won't cover the Android side in this tutorial FYI.
...
With the understanding who the JavaScript™️ side now works. Let's go the iOS side and see what we have there.
